...
var Base = _styledComponents2.default.div(_templateObject, gutter.small, gutter.large);

var Thumbnail = _styledComponents2.default.a(_templateObject2, gutter.small, gutter.small, function (props) {
	return props.landscape && (0, _styledComponents.css)(_templateObject3);
}, function (props) {
	return props.square && (0, _styledComponents.css)(_templateObject4);
}, gutter.large, gutter.large);

var Source = _styledComponents2.default.img(_templateObject5);
	...
	Gallery.prototype.renderGallery = function renderGallery() {
		...
		var gallery = images.map(function (obj, i) {
			return _react2.default.createElement(
				...
				_react2.default.createElement(Source, { src: obj.thumbnail })
			);
		});
